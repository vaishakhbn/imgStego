...
class AES {
	...
	public static void main (String[] args) {
		...
		try {FileReader fr=new FileReader("C:/Users/user/Documents/Intconf.txt");
		BufferedReader br=new BufferedReader(fr);
		
		String s=null;
		while((s=br.readLine())!=null){ FileContents=FileContents+s; System.out.println(s); } } catch(Exception e){} 
